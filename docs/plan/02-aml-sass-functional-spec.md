...
│  명단종류: PEP · 소스: DOW_JONES_PEP · 제공처: Dow Jones Risk & Compliance   │
│  매칭 이름(마스킹): hmac:pep-…001 · 점수: 0.93 · 연계 WLF 판정: scr_…a1 ▶    │
│  ┌─ 식별정보 비교(참고) ────────────────────────────────────────────────┐ │
│  │ 항목    │ 원거래 대상(회원)        │ 명단 엔트리                    │ │
│  │ 이름    │ 홍*동 [원문 열람]        │ Juan D**a C**z [원문 열람]     │ │
│  │ 국적    │ PH [원문 열람]           │ PH [원문 열람]                 │ │
│  │ 성별    │ M [원문 열람]            │ (명단에 없음)                  │ │
│  │ 생년월일│ 19**-**-** [원문 열람]   │ 1975-**-** [원문 열람]         │ │
│  └──────────────────────────────────────────────────────────────────────┘ │
│  ※ 셀별 마스킹+[원문 열람](aml:pii:reveal·RAW_DATA_ACCESS 감사) · 명단 미보유 │
│    필드는 "명단에 없음" · identity 부재(구 알림·fallback) 시 비교 블록 숨김   │
