...
├──────────────────────────────────────────────────────────────────────────┤
│ ▼ alt-3277 알림 상세 (STR PEP)                        [대상 360° ▶]        │
│ ┌─ 트리거 ─────────────────────────────────────────────────────────────┐ │
│ │ 룰: STR PEP(STR_PEP) · 사유코드: PEP · 설명: PEP 관련 거래 STR 검토     │ │
│ ├─ 명단 매칭 근거 (watchlistMatch) ─────────────────────────────────────┤ │
│ │ 명단종류: PEP · 소스: DOW_JONES_PEP · 제공처: Dow Jones Risk & Comp.    │ │
│ │ 매칭 이름(마스킹): hmac:pep-…001 · 점수: 0.93 · 연계 WLF 판정: scr_…a1 ▶│ │
│ └──────────────────────────────────────────────────────────────────────┘ │
