...
- **미완료 경계(2026-07-12)**: P0-01(`/aml/v1/**` filter), P0-04(내부 service-auth·bo-api→FDS signer), P0-14(multipart raw-byte signer), P1-02(machine credential 폐기·유예회전·last-used·rate/network/workload 통제)는 미완료다. 본 연동 문서의 v2 계약만으로 해당 호출 경로나 운영 lifecycle 적용 완료를 주장하지 않는다.
