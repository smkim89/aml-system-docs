...
| 2026-08-24 | v4.16 | **V28 legacy archive 감사 hash-chain backfill(V33, F-006).** §5.32에 21개 `RULE_ARCHIVE` provenance·V22 chain append·재실행 중복 0 계약을 추가하고 §8 migration 표/헤더를 V33으로 갱신했다. | 코드 truth=`V33__legacy_rule_archive_audit_chain.sql`·`LegacyRuleArchiveAuditMigrationIntegrationTest`·`FdsAuditHashChainVerificationService`. |
