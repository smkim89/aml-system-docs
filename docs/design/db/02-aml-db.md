...
| V10 | `V10__watchlist_entry_browse_indexes.sql` | **워치리스트 엔트리 브라우즈 인덱스**(feature/watchlist-entries-browser): 날짜별 추가분·명단별 페이징 조회(42k+ 실명단) 성능 보조 인덱스. 실제 파일 내용 1:1 — 저장소 정본 참조. | V9 |
