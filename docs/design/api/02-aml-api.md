...
| `ingestedAt` | string(date-time)\|null | **회원 최초 인입 시각**(`aml_customers.created_at`, additive 2026-09-08) — 목록 `sort=INGESTED_AT_DESC` 의 정렬 키·화면 "인입시각" 컬럼. 고객 행이 없으면 null |
