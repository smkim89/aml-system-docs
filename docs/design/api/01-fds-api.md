...
| POST | `/api/v1/admin/fds/risk-groups/{groupId}/members` | member 추가(watchlist/denylist 반영). **즉시 반영(200, `GroupMemberMutationResponse`)** — 결재 없이 동기 mutation | `fds:admin:group` | — |
