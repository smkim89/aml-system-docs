...
| matchedRules | RuleRef[] (`ruleId`,`versionNo`,`outcome`) | `matched_rules` |
  ...
  schemas:
    ...
    RuleRef:
      ...
      properties:
        ...
        outcome: { $ref: '#/components/schemas/Decision' }
