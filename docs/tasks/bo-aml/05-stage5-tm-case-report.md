# BOA-S5 · TM·케이스·규제 보고·기관 RBA (AML-TM-001/002 · AML-CASE-001/002 · AML-REP-001/002 · AML-IRA-001) — (Travel Rule 은 2026-07-09 전면 제거)

> **목표**: 거래 모니터링 알림→케이스 조사→STR/CTR 보고(FIU 폐루프)·기관 위험평가 지표 보고까지 규제 업무 본선 완성. (Travel Rule 예외 처리는 2026-07-09 Travel Rule 전면 제거로 삭제 — aegis-aml 84997e1.)
> **선행**: BOA-S1·S3(WLF 확정→케이스)·S4(EDD 착수·체크리스트). **PPT**: 슬라이드 39~58. **tipping-off 가드(BOA-S1-03) 전 화면 적용.**

## 공통 참고 문서
- PRD §7.1(TM)·§12-A.6(빌더)·§8.1(케이스)·§12-A.7(상세)·§9.1(REP)·§12-A.8(보고 상세)·§12-B.2(IRA) / 상태머신 §1.7(알림·케이스·보고 8종 FIU 폐루프)·케이스 타입 §1.10 (구 §10.1 Travel Rule 은 2026-07-09 전면 제거)
- API `02-aml-api.md`: alerts·tm-scenarios(simulate·`:activate`🔒 `TM_SCENARIO`)·cdd/cases(PATCH·timeline·`:close`🔒·`:reject-relationship`🔒)·reports(`:submit`🔒 STR/CTR_SUBMIT·`:reject`🔒·`:cancel`🔒 — reasonCode 필수) (구 travel-rule/transfers `:resolve-exception`🔒 는 2026-07-09 Travel Rule 전면 제거로 삭제)
...
| ~~BOA-S5-13~~ | ~~BE~~ | ~~**Travel Rule 프록시** — transfers 목록·`:resolve-exception`🔒 위임~~ 제거됨(2026-07-09 Travel Rule 전면 제거, aegis-aml 84997e1) | ~~API / PRD §10.1~~ | ~~2~~ | ~~S1~~ |
| ~~BOA-S5-14~~ | ~~FE~~ | ~~**AML-TR-001 3탭** — ①예외 큐(정보 누락 3종·위험 지갑) ②전체 이전 ③처리 이력 + `[예외처리🔒]`~~ 제거됨(2026-07-09 Travel Rule 전면 제거, aegis-aml 84997e1) | ~~PRD §10.1(BR 전수·completeness 3종) / PPT 슬라이드 56~58~~ | ~~3~~ | ~~S5-13~~ |
